...
class Pinterest:
    ...
    def __init__(self):
        self.board_id = Pinterest.get_access_token('FACEBOOK_PAGE_ID')
        self.board_access_token = Pinterest.get_access_token('FACEBOOK_PAGE_ACCESS_TOKEN')
...
# write your code below
    def publish_photo_msg(self, message, image_url):
        params = {
            'access_token' : self.board_access_token
        }
        data = {
            'image_url' : image_url,
            'note' : message,
