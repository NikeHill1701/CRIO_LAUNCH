...
class Facebook:
    ...
    def publish_photo_msg(self, message, image_url):
        ...
        # response = requests.post('https://graph.facebook.com/v5.0/{page-id}/photos?access_token={page-access-token}', data=data)
...
if __name__ == '__main__':
    ...
    image_url = 'https://www.handletheheat.com/wp-content/uploads/2015/07/How-to-make-ice-cream-without-a-machine-square.jpg'
    my_name = 'Nikhil'
